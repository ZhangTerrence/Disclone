...
public class UserController : ControllerBase
{
    ...
    public async Task<IActionResult> GetUserByName([FromRoute] string userName)
    {
        try
        {
            ...
            if (user is null)
            {
                return NotFound(ErrorResponseDTO.New(["GetUserByName"], [["User not found."]]));
            }
    ...
    public async Task<IActionResult> StartFriendship([FromBody] StartFriendshipRequestDTO body)
    {
        try
        {
            ...
            {
                return NotFound(ErrorResponseDTO.New(["FindByIdAsync"], [["User not found."]]));
            }
            ...
            {
                return BadRequest(ErrorResponseDTO.New(["GetFriendship"],
    ...
    public async Task<IActionResult> UpdateFriendship([FromBody] UpdateFriendshipRequestDTO body)
    {
        try
        {
            ...
            {
                return NotFound(ErrorResponseDTO.New(["GetFriendship"], [["No friend request found."]]));
            }
